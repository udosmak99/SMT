<%@ Page Title="" Language="VB" MasterPageFile="~/admin.master" AutoEventWireup="false" CodeFile="Add_User.aspx.vb" Inherits="Add_User" %>


<asp:Content ID="Content1" ContentPlaceHolderID="DetailContent" Runat="Server">
 <asp:UpdatePanel ID="UpdatePanelAdd" runat="server">
                        <ContentTemplate>
    <div class="head "><img src="images/user-icon2.png" align="absmiddle"/><span>เพิ่มข้อมูลผู้ใช้งาน</span></div>
<form>
...
<asp:Panel ID="pnlConfirm" runat="server" Visible="false" CssClass="panelbox" Width="176px">
        ...
        <asp:Label ID="lblalert" Text="เพิ่มข้อมูลผู้ใช้สำเร็จ" runat="server"></asp:Label><br />
        <br />
  ...
  <script type="text/javascript">
      ...
      function NextPage() {   
          window.location = "Show_User.aspx";
      }
</script>
   </ContentTemplate>
                        </asp:UpdatePanel>
